...
for (dw in draw_weight_grid) {
  ...
  for (alpha in alpha_grid) {
    ...
    #  draw_weight = dw,
    #  alpha = alpha,
    #  stage1_best_iter = model_stage1$best_iteration,
    #  accuracy = accuracy,
    #  logloss = logloss,
...
# =========================
# 8) final prediction with best params
# =========================
...
message("========== Two-Stage V3 Final Result ==========")
...
# 9) Stage diagnostics
# =========================
stage1_pred_label_050 <- ifelse(best_p_draw >= 0.5, 1, 0)
